...
class DocumentNumber implements ValidationRule
{
    ...
    public function validate(string $attribute, mixed $value, Closure $fail): void
    {
        ...
        $isValid = match ($this->type) {
            'PASSPORT' => (bool) preg_match('/^([А-ЯІЄЇ]{2}\d{6}|\d{9})$/u', (string) $value),
            ...
            'TEMPORARY_CERTIFICATE' => (bool) preg_match('/^(((?![ЫЪЭЁ])([А-ЯҐЇІЄ])){2}[0-9]{4,6}|[0-9]{9}|((?![ЫЪЭЁ])([А-ЯҐЇІЄ])){2}[0-9]{5}\\/[0-9]{5})$/u', (string) $value),
