    ...
    */
    ...
    'custom' => [
        ...
        'document_number_format' => [
            'PASSPORT' => '«:document»: серія та номер мають бути у форматі 2 літери (А–Я, Ґ, Є, І, Ї) та 6 цифр (наприклад, АА123456) або 9 цифр для ID-картки. Без пробілів.',
            ...
            'PERMANENT_RESIDENCE_PERMIT' => '«:document»: допускаються лише літери, цифри, дефіс та пробіл.',
