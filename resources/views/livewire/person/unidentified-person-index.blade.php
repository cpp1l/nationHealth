            ...
            <div x-data="{
                ...
                <div>
                    ...
                    <div x-show="showAdditionalParams" x-transition x-cloak>
                        <div class="form-row-3">
                            <div class="form-group group">
                                <input x-model="searchSecondName"
                                       type="text"
                        ...
                        <div class="form-row-3">
                            <div class="form-group group">
                                <input x-model="searchPhoneNumber"
                            ...
                            <div class="form-group group">
                                <input x-model="searchBirthCertificate"
                                       type="text"
